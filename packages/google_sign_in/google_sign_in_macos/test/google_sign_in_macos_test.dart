...
import 'package:google_sign_in_macos/google_sign_in_macos.dart';
import 'package:google_sign_in_macos/src/utils.dart';
...
void main() {
  ...
  final GoogleSignInMacOS googleSignIn = GoogleSignInMacOS();
  ...
  test('registered instance', () {
    ...
    expect(GoogleSignInPlatform.instance, isA<GoogleSignInMacOS>());
  });
